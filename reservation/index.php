                        ...
                        <div>
                            ...
                            <div class="custom-select pick-up form-input">
                                ...
                                <div class="custom-select-options">
                                    <span <?php echo (isset($pick_up_location) && $pick_up_location === "Choose Location") ? 'class="selected"' : "" ?>>Choose Location</span>
                    ...
                    <div class="main-itinerary-box">
                        <div <?php if (!isset($itinerary) || $itinerary['returnToSameLocation']['value'] === 'on') echo 'style="display: none;"'; ?>>
                            ...
                            <div class="custom-select return form-input">
                                ...
                                <div class="custom-select-options">
                                    <span <?php echo isset($return_location) && $return_location === "Choose Location" ? 'class="selected"' : "" ?>>Choose Location</span>
